...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      booking_assignment_state_history: {
        Row: {
          ...
          created_at: string
          from_state:
            | Database["public"]["Enums"]["booking_assignment_state"]
            | null
          id: string
          metadata: Json
          reason: string | null
      ...
      bookings: {
        Row: {
          ...
          id: string
          idempotency_key: string | null
          last_auto_assign_job_result: Json | null
      ...
      table_inventory: {
        ...
        Relationships: [
          {
            foreignKeyName: "table_inventory_allowed_capacity_fk"
    ...
    Functions: {
      ...
      assign_tables_backtracking: {
        Args: {
          p_assigned_by?: string
          p_booking_id: string
          p_idempotency_key?: string
          p_require_adjacency?: boolean
          p_table_candidates: string[]
        }
        Returns: {
          end_at: string
          merge_group_id: string
      ...
      assignment_lock_claim: {
        Args: { p_booking_id: string; p_owner?: string; p_ttl_ms?: number }
        Returns: {
          acquired: boolean
          expires_at: string
          owner: string
      ...
      assignment_lock_release: {
        Args: { p_booking_id: string; p_owner: string }
        Returns: {
          released: boolean
        }[]
      }
