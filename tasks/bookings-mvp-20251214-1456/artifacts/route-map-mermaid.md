...
flowchart TD
    subgraph Pages
        ...
        class auth_forgot_password public;
    ...
    subgraph API
        ...
        subgraph Test
            ...
            api_test_reservations__id_confirmation["/api/test/reservations/:id/confirmation"]
            class api_test_reservations__id_confirmation public;
