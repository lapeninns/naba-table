...
ALTER TYPE "public"."booking_assignment_state" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."assign_tables_backtracking"("p_booking_id" "uuid", "p_table_candidates" "uuid"[], "p_idempotency_key" "text" DEFAULT NULL::"text", "p_require_adjacency" boolean DEFAULT true, "p_assigned_by" "uuid" DEFAULT NULL::"uuid") RETURNS TABLE("table_id" "uuid", "start_at" timestamp with time zone, "end_at" timestamp with time zone, "merge_group_id" "uuid")
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."assign_tables_backtracking"("p_booking_id" "uuid", "p_table_candidates" "uuid"[], "p_idempotency_key" "text", "p_require_adjacency" boolean, "p_assigned_by" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."assignment_lock_claim"("p_booking_id" "uuid", "p_ttl_ms" integer DEFAULT 30000, "p_owner" "uuid" DEFAULT "gen_random_uuid"()) RETURNS TABLE("acquired" boolean, "owner" "uuid", "expires_at" timestamp with time zone)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."assignment_lock_claim"("p_booking_id" "uuid", "p_ttl_ms" integer, "p_owner" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."assignment_lock_extend"("p_booking_id" "uuid", "p_owner" "uuid", "p_ttl_ms" integer) RETURNS TABLE("extended" boolean, "expires_at" timestamp with time zone)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."assignment_lock_extend"("p_booking_id" "uuid", "p_owner" "uuid", "p_ttl_ms" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."assignment_lock_release"("p_booking_id" "uuid", "p_owner" "uuid") RETURNS TABLE("released" boolean)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."assignment_lock_release"("p_booking_id" "uuid", "p_owner" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."record_observability_event"("p_source" "text", "p_event_type" "text", "p_severity" "text" DEFAULT 'info'::"text", "p_restaurant_id" "uuid" DEFAULT NULL::"uuid", "p_booking_id" "uuid" DEFAULT NULL::"uuid", "p_context" "jsonb" DEFAULT NULL::"jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."record_observability_event"("p_source" "text", "p_event_type" "text", "p_severity" "text", "p_restaurant_id" "uuid", "p_booking_id" "uuid", "p_context" "jsonb") OWNER TO "postgres";
...
BEGIN
  ...
  -- CHANGED: Always populate table_hold_windows, don't check GUC
  -- This ensures the exclusion constraint works regardless of connection pooling issues
  IF TG_OP = 'INSERT' THEN
...
CREATE OR REPLACE FUNCTION "public"."update_table_hold_windows"() RETURNS "trigger"
    ...
    AS $$
BEGIN
  -- CHANGED: Always update table_hold_windows, don't check GUC
...
ALTER TABLE "public"."booking_assignment_state_history" OWNER TO "postgres";
...
CREATE INDEX "analytics_events_restaurant_occurred_idx" ON "public"."analytics_events" USING "btree" ("restaurant_id", "occurred_at" DESC);
...
CREATE INDEX "table_hold_windows_table_id_idx" ON "public"."table_hold_windows" USING "btree" ("table_id");
...
CREATE INDEX "table_hold_windows_window_gist_idx" ON "public"."table_hold_windows" USING "gist" ("hold_window");
...
CREATE OR REPLACE TRIGGER "allowed_capacities_set_updated_at" BEFORE UPDATE ON "public"."allowed_capacities" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "booking_occasions_set_updated_at" BEFORE UPDATE ON "public"."booking_occasions" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "booking_slots_set_updated_at" BEFORE UPDATE ON "public"."booking_slots" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "booking_table_assignments_set_updated_at" BEFORE UPDATE ON "public"."booking_table_assignments" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "capacity_outbox_set_updated_at" BEFORE UPDATE ON "public"."capacity_outbox" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "demand_profiles_set_updated_at" BEFORE UPDATE ON "public"."demand_profiles" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "feature_flag_overrides_set_updated_at" BEFORE UPDATE ON "public"."feature_flag_overrides" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "loyalty_points_set_updated_at" BEFORE UPDATE ON "public"."loyalty_points" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "loyalty_programs_set_updated_at" BEFORE UPDATE ON "public"."loyalty_programs" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "restaurant_capacity_rules_set_updated_at" BEFORE UPDATE ON "public"."restaurant_capacity_rules" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "restaurant_invites_set_updated_at" BEFORE UPDATE ON "public"."restaurant_invites" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "restaurant_operating_hours_set_updated_at" BEFORE UPDATE ON "public"."restaurant_operating_hours" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "restaurant_service_periods_set_updated_at" BEFORE UPDATE ON "public"."restaurant_service_periods" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "service_policy_set_updated_at" BEFORE UPDATE ON "public"."service_policy" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "strategic_configs_set_updated_at" BEFORE UPDATE ON "public"."strategic_configs" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "table_holds_set_updated_at" BEFORE UPDATE ON "public"."table_holds" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "table_inventory_set_updated_at" BEFORE UPDATE ON "public"."table_inventory" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "zones_set_updated_at" BEFORE UPDATE ON "public"."zones" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE POLICY "Tenant service role can manage table hold members" ON "public"."table_hold_members" TO "service_role" USING ((EXISTS ( SELECT 1
   FROM "public"."table_holds" "h"
...
GRANT ALL ON FUNCTION "public"."assign_tables_backtracking"("p_booking_id" "uuid", "p_table_candidates" "uuid"[], "p_idempotency_key" "text", "p_require_adjacency" boolean, "p_assigned_by" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."assignment_lock_claim"("p_booking_id" "uuid", "p_ttl_ms" integer, "p_owner" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."assignment_lock_extend"("p_booking_id" "uuid", "p_owner" "uuid", "p_ttl_ms" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."assignment_lock_release"("p_booking_id" "uuid", "p_owner" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."record_observability_event"("p_source" "text", "p_event_type" "text", "p_severity" "text", "p_restaurant_id" "uuid", "p_booking_id" "uuid", "p_context" "jsonb") TO "service_role";
GRANT ALL ON FUNCTION "public"."record_observability_event"("p_source" "text", "p_event_type" "text", "p_severity" "text", "p_restaurant_id" "uuid", "p_booking_id" "uuid", "p_context" "jsonb") TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."_migrations" TO "service_role";



GRANT SELECT,USAGE ON SEQUENCE "public"."_migrations_id_seq" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."booking_assignment_attempts" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."booking_assignment_idempotency" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."booking_assignment_state_history" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."booking_confirmation_results" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."booking_occasions" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."booking_occasions_audit" TO "service_role";
...
GRANT SELECT,DELETE,UPDATE ON TABLE "public"."bookings" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."capacity_outbox" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."demand_profiles" TO "service_role";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."demand_profiles" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."feature_flag_overrides" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."observability_events" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."strategic_configs" TO "service_role";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."strategic_configs" TO "authenticated";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."table_hold_members" TO "service_role";
GRANT SELECT ON TABLE "public"."table_hold_members" TO "authenticated";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."table_hold_windows" TO "service_role";



GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."table_holds" TO "service_role";
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."table_scarcity_metrics" TO "service_role";
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."table_scarcity_metrics" TO "authenticated";
