 ...
 * settings-nav prefetchers both pass these. A hook-level staleTime wins over the
 * prefix defaults registered by applyQueryDefaults, and prefetchIfStale resolves
 * freshness through `queryClient.defaultQueryOptions`, so prefetch and page mount agree.
 */
