...
For all six elements assembled into one coherent Micro-Spec, see `micro-specs/00-foundation/01-micro-spec-governance.md`. Match its heading set and ordering so newly authored specs stay consistent with the existing corpus.
