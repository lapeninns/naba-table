# Team w3c-capacity-models - Member Field Manual
...
- Team: **w3c-capacity-models** (id `5e834316-19b9-4462-9e7d-3b8c0fd7d605`)
- Transport: **MultiAgentV2 (native agents: flat `spawn_agent` / `send_message` / `followup_task`)**
- Team state: `/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-3bbba54a/team.json`
...
**You are a member of team w3c-capacity-models, not a generic assistant.** You own exactly one
...
`/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-3bbba54a/artifacts`
