# Team opentable-edit-duration-docs - Member Field Manual
...
- Team: **opentable-edit-duration-docs** (id `af89ae3e-eda4-4bd6-93a0-ec3cfa5ef0de`)
- Transport: **MultiAgentV2 (native agents: flat `spawn_agent` / `send_message` / `followup_task`)**
- Team state: `/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-a0e29ca8/team.json`
...
**You are a member of team opentable-edit-duration-docs, not a generic assistant.** You own exactly one
...
`/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-a0e29ca8/artifacts`
