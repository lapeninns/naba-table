# Team opentable-special-day-duration-sshh - Member Field Manual
...
- Team: **opentable-special-day-duration-sshh** (id `662302a3-8938-4e1d-bdec-8e93c6bf71b5`)
- Transport: **MultiAgentV2 (native agents: flat `spawn_agent` / `send_message` / `followup_task`)**
- Team state: `/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-3b9c3394/team.json`
...
**You are a member of team opentable-special-day-duration-sshh, not a generic assistant.** You own exactly one
...
`/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-3b9c3394/artifacts`
