# Team quandoo-consumer-display - Member Field Manual
...
- Team: **quandoo-consumer-display** (id `5376a8d7-7b51-4761-886f-b77385f9ec61`)
- Transport: **MultiAgentV2 (native agents: flat `spawn_agent` / `send_message` / `followup_task`)**
- Team state: `/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-17c2a682/team.json`
...
**You are a member of team quandoo-consumer-display, not a generic assistant.** You own exactly one
...
- **A** "uk-english-live" (area) - UK and English-language official Quandoo restaurant pages and live booking widgets -> 10+ varied official-domain queries, opened restaurant pages, exact short guest-visible availability labels, dynamic-vs-SEO classification, URLs and 2026-07-16 access date, CLAIMS and EXPAND tails | task `quandoo_uk_english_live` | agent `/root/quandoo_uk_english_live` [pending]
- **B** "german-live" (area) - German official Quandoo locale pages and live booking widgets -> 10+ varied official-domain queries, opened restaurant pages, exact German guest-visible availability labels with translations, dynamic-vs-SEO classification, URLs and access date, CLAIMS and EXPAND tails | task `quandoo_german_live` | agent `/root/quandoo_german_live` [pending]
- **C** "french-live" (area) - French official Quandoo locale pages and live booking widgets -> 10+ varied official-domain queries, opened restaurant pages, exact French guest-visible availability labels with translations, dynamic-vs-SEO classification, URLs and access date, CLAIMS and EXPAND tails | task `quandoo_french_live` | agent `/root/quandoo_french_live` [pending]
- **D** "italian-live" (area) - Italian official Quandoo locale pages and live booking widgets -> 10+ varied official-domain queries, opened restaurant pages, exact Italian guest-visible availability labels with translations, dynamic-vs-SEO classification, URLs and access date, CLAIMS and EXPAND tails | task `quandoo_italian_live` | agent `/root/quandoo_italian_live` [pending]
- **E** "dutch-other-live" (area) - Dutch and additional official Quandoo locale pages and live booking widgets -> 10+ varied official-domain queries, opened restaurant pages, exact guest-visible labels with translations, dynamic-vs-SEO classification, URLs and access date, CLAIMS and EXPAND tails | task `quandoo_dutch_other_live` | agent `/root/quandoo_dutch_other_live` [pending]
- **F** "seo-countersearch" (perspective) - Official Quandoo SEO pages, listing cards, schema/static text, sitemaps, and counter-search for operator/configuration implications -> 10+ varied official-domain queries, opened material pages, exact static labels/copy, distinguish SEO from dynamic UI, no unsupported portal inference, URLs/access date, counter-search, CLAIMS and EXPAND tails | task `quandoo_seo_countersearch` | agent `/root/quandoo_seo_countersearch` [pending]
...
`/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-17c2a682/artifacts`
