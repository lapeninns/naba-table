# Team resdiary-policy-research - Member Field Manual
...
- Team: **resdiary-policy-research** (id `ce8a793b-7fe2-4604-8744-b97847ce8fa6`)
- Transport: **MultiAgentV2 (native agents: flat `spawn_agent` / `send_message` / `followup_task`)**
- Team state: `/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-6f079c5d/team.json`
...
**You are a member of team resdiary-policy-research, not a generic assistant.** You own exactly one
...
- **A** "booking-defaults" (area) - Official help pages for booking settings, defaults, and default booking duration UI -> Exhaustive cited findings, exact labels/quotes under 20 words, dead ends, CLAIMS and EXPAND tails | task `resdiary_booking_defaults` | agent `/root/resdiary_booking_defaults` [pending]
- **B** "services-shifts" (area) - Official help pages for services, shifts, sittings, and duration-related settings -> Exhaustive cited findings, exact labels/quotes under 20 words, dead ends, CLAIMS and EXPAND tails | task `resdiary_services_shifts` | agent `/root/resdiary_services_shifts` [pending]
- **C** "availability-slots" (area) - Official help pages for availability, time slots, slot length, and duration controls -> Exhaustive cited findings, exact labels/quotes under 20 words, dead ends, CLAIMS and EXPAND tails | task `resdiary_availability_slots` | agent `/root/resdiary_availability_slots` [pending]
- **D** "tables-turntimes" (area) - Official help pages for table settings, table joins, turn times, sitting or stay time -> Exhaustive cited findings, exact labels/quotes under 20 words, dead ends, CLAIMS and EXPAND tails | task `resdiary_tables_turntimes` | agent `/root/resdiary_tables_turntimes` [pending]
- **E** "sitemap-index" (area) - Official ResDiary sitemap, help-centre indexes, related-link discovery, and legacy official domains -> Exhaustive relevant URL inventory, full-page evidence, dead ends, CLAIMS and EXPAND tails | task `resdiary_sitemap_index` | agent `/root/resdiary_sitemap_index` [pending]
- **F** "terminology-skeptic" (perspective) - Counter-search renamed terminology and challenge whether default booking duration is explicit or inferred -> Refutation-focused evidence, exact quotes, terminology mapping, dead ends, CLAIMS and EXPAND tails | task `resdiary_terminology_skeptic` | agent `/root/resdiary_terminology_skeptic` [pending]
...
`/Users/amankumarshrestha/LapenInns Project/nabatableLP/.omo/teams/team-6f079c5d/artifacts`
