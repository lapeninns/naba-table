-- Migration: Remove transaction isolation adjustment inside booking RPC
-- Description: Allow function to run under PostgREST-managed transactions by dropping explicit isolation tweaks.
-- Date: 2025-10-18
