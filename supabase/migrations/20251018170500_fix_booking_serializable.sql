-- Migration: Adjust booking RPC isolation handling
-- Description: Replace SET TRANSACTION with set_config to avoid runtime errors when invoked via PostgREST.
-- Date: 2025-10-18
...
BEGIN
  EXECUTE $fn$
    ...
    DECLARE
        ...
        v_timezone_raw text;
    BEGIN
        -- Ensure serializable semantics without violating PostgREST transaction rules
