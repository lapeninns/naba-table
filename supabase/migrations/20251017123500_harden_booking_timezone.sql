-- Migration: Harden booking timezone handling for capacity-safe bookings
-- Description: Adds timezone validation/fallback to RPC + normalizes invalid restaurant timezones
-- Date: 2025-10-17
...
-- =====================================================
-- Normalize existing restaurant timezones
-- =====================================================
...
WHERE r.timezone IS NULL
   ...
   OR NOT EXISTS (
       ...
       WHERE lower(tz.name) = lower(r.timezone)
   );
