...
GRANT ALL ON TABLE "public"."booking_assignment_idempotency" TO "anon";
GRANT ALL ON TABLE "public"."booking_assignment_idempotency" TO "authenticated";
...
GRANT SELECT,REFERENCES,DELETE,TRIGGER,TRUNCATE,MAINTAIN,UPDATE ON TABLE "public"."bookings" TO "authenticated";
...
GRANT ALL ON TABLE "public"."feature_flag_overrides" TO "anon";
GRANT ALL ON TABLE "public"."feature_flag_overrides" TO "authenticated";
...
GRANT ALL ON TABLE "public"."loyalty_point_events" TO "anon";
GRANT ALL ON TABLE "public"."loyalty_point_events" TO "authenticated";
...
GRANT ALL ON TABLE "public"."table_hold_windows" TO "anon";
GRANT ALL ON TABLE "public"."table_hold_windows" TO "authenticated";
