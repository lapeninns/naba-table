...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn("border-b border-border first:rounded-t-lg last:rounded-b-lg last:border-b", className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      {...props}
    >
      <span className="flex-1 text-left leading-relaxed">{children}</span>
