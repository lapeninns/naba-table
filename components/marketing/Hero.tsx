  ...
  return (
    <section className="relative overflow-hidden pt-16 pb-24 lg:pt-32 lg:pb-40 bg-gradient-to-b from-slate-50 via-white to-slate-50/50">
      ...
      <div className="container mx-auto px-4 md:px-6 relative flex flex-col items-center text-center">
        <Badge
          variant="secondary"
          className="mb-6 bg-primary/10 text-primary hover:bg-primary/20 transition-colors"
        >
          Booking made simple
        </Badge>
        ...
        <p className="mt-6 max-w-2xl text-lg text-slate-600 sm:text-xl leading-relaxed">
          Browse partner restaurants, book in seconds, and manage every reservation from one place -
          mobile first, keyboard friendly, and instant confirmations included.
        </p>
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          ...
          <Link href="/auth">
            <Button
              variant="outline"
              size="lg"
              className="h-12 px-8 text-base bg-white/80 backdrop-blur-sm hover:bg-slate-50 border-slate-200"
            >
              Sign in to manage
            </Button>
          </Link>
