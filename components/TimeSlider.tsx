      ...
      <div className="flex-1 relative pt-4 pb-2">
        ...
        <div className="relative flex w-full touch-none select-none items-center h-6">
          ...
          <Input
            ...
            max="1320"
            step="15"
            className="absolute z-20 h-full w-full cursor-pointer border-0 bg-transparent p-0 opacity-0 shadow-none"
            type="range"
            value="720"
          />
          <div
        ...
        <div className="relative flex justify-between mt-2 text-[10px] font-medium text-slate-400 uppercase tracking-wide">
          ...
          <span className="absolute transform -translate-x-1/2" style={{ left: '10%' }}>
            1 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '20%' }}>
            2 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '30%' }}>
            3 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '40%' }}>
            4 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '50%' }}>
            5 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '60%' }}>
            6 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '70%' }}>
            7 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '80%' }}>
            8 PM
          </span>
          <span className="absolute transform -translate-x-1/2" style={{ left: '90%' }}>
            9 PM
          </span>
