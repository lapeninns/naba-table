...
function FactoryStyles() {
  return (
    <style jsx global>{`
      ...
      .factory-page .text-subtle {
        color: var(--muted-foreground);
      }
      .factory-page .text-brand {
        color: var(--brand-blue);
      }

      .factory-page .bg-surface {
        background-color: var(--background);
      }
    ...
    <div className="search-pill-container bg-[var(--card)] rounded-full flex flex-col md:flex-row items-center p-2 max-w-4xl mx-auto relative z-20">
      <div className="search-pill-section w-full md:flex-1 px-6 py-2 cursor-pointer relative group border-b md:border-b-0 border-[var(--slate-100)]">
        <label
          ...
          className="block text-xs font-bold text-[var(--slate-900)] mb-0.5"
        >
          Where
        </label>
        <input
    ...
    <div className="bg-[var(--card)] rounded-xl border border-[var(--border)] shadow-card p-6 h-full flex flex-col">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold uppercase tracking-wider text-[var(--slate-500)]">
            Live Feed
          </span>
        </div>
    ...
    <header className="pt-20 pb-16 px-6 bg-[var(--slate-50)] border-b border-[var(--border)]">
      <div className="max-w-4xl mx-auto text-center space-y-8 mb-12">
        ...
        <p className="text-body max-w-2xl mx-auto">
          Search curated restaurants, see live openings, and secure your table with concierge-level
          speed. No apps to download, no &quot;request pending&quot; limbo.
        </p>
      </div>
          ...
          <div className="shadow-card rounded-xl p-8 bg-[var(--brand-blue)] text-white h-full relative overflow-hidden flex flex-col justify-between min-h-[300px]">
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-blue-100 max-w-sm">
                From tap to confirmed ticket. Our direct integration means what you see is what you
                get.
              </p>
            </div>
            <Icon
              name="zap"
              className="absolute bottom-[-20px] right-[-20px] w-64 h-64 text-white opacity-10"
            />
          </div>
        </div>
            ...
            <MetricTile
              ...
              icon={
                <Icon
                  name={metric.icon}
                  className={
                    metric.icon === 'clock' ? 'text-[var(--brand-blue)]' : 'text-[var(--amber-500)]'
                  }
                />
              }
            />
        ...
        <div className="md:col-span-1 bg-[var(--slate-900)] text-white rounded-xl p-6 shadow-card flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <p className="text-sm text-[var(--slate-400)]">
              Availability mirrors what guests see post-booking.
            </p>
          </div>
          <Button
            variant="secondary"
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        <div className="space-y-6">
          ...
          <p className="text-body">
            Your receipt is ready the moment you book. Calendar file, shareable link, and live
            status—accessible from email or My Bookings without re-learning the flow.
          </p>
        ...
        <div className="relative">
          ...
          <div className="bg-[var(--card)] rounded-2xl shadow-float border border-[var(--border)] p-6 relative z-10 space-y-4">
            <div className="flex justify-between items-center border-b border-[var(--border)] pb-4">
              <div>
                <div className="text-xs font-bold text-[var(--slate-500)] uppercase">
                  Confirmation
                </div>
