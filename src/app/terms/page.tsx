      ...
      <div className="space-y-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <Section title="Liability">
          <p className="text-sm text-slate-700">
            SajiloReserveX provides booking coordination; restaurants deliver the dining service. To the maximum extent permitted by law, we
            are not liable for indirect or consequential damages. Your statutory consumer rights remain unaffected where applicable.
          </p>
        </Section>
