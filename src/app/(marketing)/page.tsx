...
export default function MarketingHomePage() {
  return (
    <div className="min-h-screen bg-slate-50/30 selection:bg-primary/10 selection:text-primary flex flex-col">
      ...
      {/* Main content only - Layout wrapper handles header/footer if configured properly, 
          but since we're moving this to (marketing)/page.tsx which uses MarketingLayout,
          we should remove explicit Header/Footer calls if MarketingLayout provides them.
          However, MarketingLayout DOES provide them. So I will strip them here.
       */}
