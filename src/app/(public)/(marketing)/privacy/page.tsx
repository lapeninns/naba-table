import { GuestHero } from '@/components/guest/ui';
  ...
  return (
    <article>
      <GuestHero
        ...
        title="How guest data is handled."
        description="Nab a Table helps diners discover restaurants and confirm reservations. This policy explains what information we collect, why we use it, and the choices you have."
        compact
      />
      <div className="pg-container pg-section-tight space-y-10">
        ...
        <section id="information-we-collect" className="space-y-4">
          ...
          <ul className="pg-body list-disc space-y-2 pl-5">
            <li>
              Contact details you submit, such as name, email address, and phone number when
              creating or managing bookings.
            </li>
            <li>
              Reservation details like party size, date, time, occasion notes, and dining
              preferences.
            </li>
            <li>
              Account and authentication information if you create an account or sign in using magic
              links.
            </li>
            <li>
              Usage data about how you interact with our site, such as pages viewed and device
              information.
            </li>
            <li>Communications with support or restaurants, including feedback and requests.</li>
          </ul>
        </section>
        ...
        <section id="sharing" className="space-y-4">
          ...
          <ul className="pg-body list-disc space-y-2 pl-5">
            ...
            <li>
              Service providers may process data on our behalf for hosting, analytics, or support
              tools.
            </li>
            <li>
        ...
        <section id="cookies" className="space-y-4">
          ...
          <p className="pg-body max-w-3xl">
            ...
            understand site performance. You can manage cookies in your browser settings. Some
        ...
        <section id="retention" className="space-y-4">
          ...
          <p className="pg-body max-w-3xl">
            We keep information only as long as needed for bookings, legal requirements, and
            legitimate business purposes. When data is no longer required, we delete or anonymize
            it.
          </p>
        </section>
        ...
        <section id="security" className="space-y-4">
          ...
          <p className="pg-body max-w-3xl">
            ...
            No system is fully secure, so please contact us if you suspect unauthorized access.
          </p>
        </section>
        ...
        <section id="updates" className="space-y-4">
          ...
          <p className="pg-body max-w-3xl">
            ...
            may notify you of significant changes.
          </p>
        </section>
      </div>
    </article>
