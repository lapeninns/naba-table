...
export async function GET(request: Request) {
  ...
  const filters: RestaurantFilters = {
    ...
    timezone: parsed.data.timezone && parsed.data.timezone !== "all" ? parsed.data.timezone : undefined,
  ...
  try {
    ...
    response.headers.set("Link", "</api/restaurants>; rel=\"predecessor-version\"");
    return response;
  } catch (error) {
