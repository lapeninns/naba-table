...
async function ensureAuthorized(restaurantId: string): Promise<NextResponse | null> {
  ...
  try {
    ...
    console.error('[owner][restaurants][hours] membership validation failed', error);
...
export async function GET(_req: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    return handleUnexpectedError(error, '[owner][restaurants][hours][GET]');
  }
}
...
export async function PUT(req: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    return handleUnexpectedError(error, '[owner][restaurants][hours][PUT]');
  }
}
