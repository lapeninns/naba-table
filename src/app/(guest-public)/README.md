...
| -------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------- |
| `(marketing)`        | `/`, `/product`, `/pricing`, `/contact`                                                                 | `OwnerMarketingNavbar` (Product/Pricing/Contact/Sign in) + dark footer (“Built for restaurants, not marketplaces”) | Primary owner-focused SaaS funnel with CTA → `/ops/login` and `mailto:SUPPORT_EMAIL`. |
...
- `/ops/login` remains the only unauthenticated ops route; authenticated users auto-redirect to `/ops` or the provided `redirectedFrom`.
