...
const PLANS = [
  {
    ...
    description: "Launch direct bookings with live pacing and messaging for a single venue.",
    features: ["Unlimited reservations", "Embeddable booking widgets", "Ops console + mobile app", "Email support"],
  ...
  },
  {
    ...
    price: "$499",
    cadence: "per month / location",
    description: "Multi-venue management with automation, analytics, and premium success hours.",
    features: [
      "Journey automations",
      "Channel attribution + exports",
      "Priority success manager",
      "Team roles & advanced permissions",
    ],
    highlight: true,
  ...
  },
  {
    ...
    price: "Custom",
    cadence: "",
    description: "Group rollouts with SLAs, SSO, and tailored integrations.",
    features: ["Dedicated CSM + migrations", "SSO & SOC2 toolkit", "Warehouse & POS integrations", "Phone + chat support"],
