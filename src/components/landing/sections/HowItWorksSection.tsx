          ...
          {HOW_IT_WORKS_STEPS.map((step, index) => (
            ...
            >
              <CardHeader className="flex flex-col items-center gap-3 space-y-0 p-5 sm:p-6 md:gap-4">
                <div className="z-10 flex size-12 items-center justify-center rounded-full border-4 border-background bg-primary text-lg font-bold text-primary-foreground sm:text-xl">
                  {index + 1}
                </div>
