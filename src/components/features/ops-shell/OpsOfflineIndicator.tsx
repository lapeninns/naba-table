      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1">
            <AlertTitle className="text-sm font-semibold text-amber-900">You are offline</AlertTitle>
            <AlertDescription className="text-sm text-amber-900/80">
              Navigation is paused until you reconnect. We will keep showing cached data where available.
            </AlertDescription>
          </div>
        </div>
        <Button
