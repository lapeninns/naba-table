...
export function ProfileSectionShell({
  ...
  return (
    <Card id={id} className={cn('scroll-mt-24', SETTINGS_COMPACT_CARD_CLASS, className)}>
      <CardHeader
        className={cn(
      ...
      <CardContent
        className={cn('flex flex-col gap-4', SETTINGS_COMPACT_CARD_CONTENT_CLASS, contentClassName)}
      >
        {children}
      </CardContent>
    </Card>
