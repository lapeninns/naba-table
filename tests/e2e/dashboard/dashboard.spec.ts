...
const shouldRunDashboardFlow = process.env.PLAYWRIGHT_TEST_DASHBOARD === 'true';
...
test.describe('dashboard cancel flow', () => {
  test.skip(!shouldRunDashboardFlow, 'Enable PLAYWRIGHT_TEST_DASHBOARD=true with valid credentials to exercise dashboard flow.');
