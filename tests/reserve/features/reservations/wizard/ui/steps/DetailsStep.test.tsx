...
describe('DetailsStep', () => {
  ...
  it('locks contact fields the account already owns @contract', () => {
    ...
    expect(
      screen.getByText('Email is linked to your account. Update it from your profile to change it.'),
    ).toBeInTheDocument();
  });
  ...
  it('marks contacts optional and hides guest preferences in ops mode @contract', () => {
    ...
    expect(screen.getByText('At least one contact method (email or phone) is required.')).toBeInTheDocument();
