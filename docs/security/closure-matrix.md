...
| Recovery token flow permits contact mismatch                                | SEC-001         | Pending | `tests/server/security/booking-access-token.test.ts`, `tests/server/guest-booking-access-resolver.test.ts`                                       | Not applicable                                                                | Pending     | regression-covered |
