# Restaurant-settings ops UI contract

> Scope: the restaurant-settings command centre in the ops app (Wave 3). This file applies the
> shared design system in [`DESIGN.md`](../../DESIGN.md) to these screens and adds no tokens of
> its own. Tokens, type and components come from `DESIGN.md`.
