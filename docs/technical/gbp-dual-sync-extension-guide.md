...
Use this guide before adding any new Google Business Profile field family, write group, or FoodMenus behavior. It extends the safety contract in `docs/technical/dual-sync-production-invariants.md`.
...
| Runbooks and safety docs | `docs/technical/dual-sync-production-invariants.md`, `docs/ops/dual-sync-runbooks.md`, `docs/ops/gbp-operational-safety-review.md` |
