...
- Staging evidence is complete and linked from the release record.
...
New GBP field families, write groups, and FoodMenus behavior must follow `docs/technical/gbp-dual-sync-extension-guide.md` before implementation.
