...
const INPUT_CLASS = cn('h-12 text-base', 'transition-shadow duration-200', 'focus:shadow-md');
...
export function DetailsStep({ mode = 'customer', ...props }: DetailsStepProps) {
  ...
  const description =
    mode === 'ops'
      ...
      : 'We will send confirmation and any updates to the contact details below.';
