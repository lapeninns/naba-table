...
```json
{
  "db:reset": "supabase db reset", // Full reset (migrations + seeds)
  "db:migrate": "...", // Migrations only
  "db:seed-only": "...", // Seeds only (after migrations)
  "db:full-reset": "...", // Full reset with logging
  "db:wipe": "...", // Drop public schema ⚠️
  ...
  "db:verify": "./scripts/verify-seed-final.sh" // Verify seeds
}
```
