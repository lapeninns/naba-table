...
\restrict Oj1TeVeZHblgrAgmplhlBrYUXuHK4BJgXmTS7tK1TnwlxnhJyexLsqnAmmX00k4
...
--
-- Name: FUNCTION allocations_overlap(a tstzrange, b tstzrange); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION allowed_capacities_set_updated_at(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION apply_booking_state_transition(p_booking_id uuid, p_status public.booking_status, p_checked_in_at timestamp with time zone, p_checked_out_at timestamp with time zone, p_updated_at timestamp with time zone, p_history_from public.booking_status, p_history_to public.booking_status, p_history_changed_by uuid, p_history_changed_at timestamp with time zone, p_history_reason text, p_history_metadata jsonb); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION are_tables_connected(table_ids uuid[]); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION assign_merged_tables(p_booking_id uuid, p_table_ids uuid[], p_require_adjacency boolean, p_assigned_by uuid, p_idempotency_key text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION assign_single_table(p_booking_id uuid, p_table_id uuid, p_assigned_by uuid, p_idempotency_key text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION assign_tables_atomic(p_booking_id uuid, p_table_ids uuid[], p_window tstzrange, p_assigned_by uuid, p_idempotency_key text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION assign_tables_atomic_v2(p_booking_id uuid, p_table_ids uuid[], p_idempotency_key text, p_require_adjacency boolean, p_assigned_by uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION assign_tables_atomic_v2(p_booking_id uuid, p_table_ids uuid[], p_idempotency_key text, p_require_adjacency boolean, p_assigned_by uuid, p_start_at timestamp with time zone, p_end_at timestamp with time zone); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION booking_status_summary(p_restaurant_id uuid, p_start_date date, p_end_date date, p_status_filter public.booking_status[]); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION create_booking_with_capacity_check(p_restaurant_id uuid, p_customer_id uuid, p_booking_date date, p_start_time time without time zone, p_end_time time without time zone, p_party_size integer, p_booking_type text, p_customer_name text, p_customer_email text, p_customer_phone text, p_seating_preference text, p_notes text, p_marketing_opt_in boolean, p_idempotency_key text, p_source text, p_auth_user_id uuid, p_client_request_id text, p_details jsonb, p_loyalty_points_awarded integer); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION generate_booking_reference(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_or_create_booking_slot(p_restaurant_id uuid, p_slot_date date, p_slot_time time without time zone, p_default_capacity integer); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION increment_booking_slot_version(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_holds_strict_conflicts_enabled(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_table_available_v2(p_table_id uuid, p_start_at timestamp with time zone, p_end_at timestamp with time zone, p_exclude_booking_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION log_table_assignment_change(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION on_allocations_refresh(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION on_booking_status_refresh(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION refresh_table_status(p_table_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION set_booking_instants(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION set_booking_reference(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION set_hold_conflict_enforcement(enabled boolean); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION sync_table_hold_windows(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION unassign_table_from_booking(p_booking_id uuid, p_table_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION unassign_tables_atomic(p_booking_id uuid, p_table_ids uuid[]); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION update_booking_with_capacity_check(p_booking_id uuid, p_restaurant_id uuid, p_customer_id uuid, p_booking_date date, p_start_time time without time zone, p_end_time time without time zone, p_party_size integer, p_booking_type text, p_customer_name text, p_customer_email text, p_customer_phone text, p_seating_preference text, p_notes text, p_marketing_opt_in boolean, p_auth_user_id uuid, p_client_request_id text, p_details jsonb, p_loyalty_points_awarded integer, p_source text); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION update_table_hold_windows(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION user_restaurants(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION user_restaurants_admin(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION validate_booking_capacity_after_assignment(p_booking_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION validate_table_adjacency(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE _migrations_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE allowed_capacities; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE booking_assignment_idempotency; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE booking_occasions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE booking_slots; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE booking_state_history; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE booking_state_history_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE booking_table_assignments; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE booking_versions; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE observability_events; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE capacity_selector_rejections_v1; Type: ACL; Schema: public; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.capacity_selector_rejections_v1 TO service_role;
...
--
-- Name: TABLE demand_profiles; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE loyalty_point_events; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE loyalty_points; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE profile_update_requests; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE restaurant_invites; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE restaurant_memberships; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE restaurant_operating_hours; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE restaurant_service_periods; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE service_policy; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE strategic_configs; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE strategic_simulation_runs; Type: ACL; Schema: public; Owner: -
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.strategic_simulation_runs TO service_role;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.strategic_simulation_runs TO authenticated;
...
--
-- Name: TABLE table_adjacencies; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE table_hold_members; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE table_hold_windows; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE table_holds; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE table_inventory; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE table_scarcity_metrics; Type: ACL; Schema: public; Owner: -
--
...
\unrestrict Oj1TeVeZHblgrAgmplhlBrYUXuHK4BJgXmTS7tK1TnwlxnhJyexLsqnAmmX00k4
