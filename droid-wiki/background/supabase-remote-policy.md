...
Supabase is remote-only. `README.md`, `AGENTS.md`, `scripts/db/safe-run.ts`, `scripts/validate-env.ts`, and `docs/sdlc/verification.md` require staging-first behavior and block unsafe production resource use in non-production unless explicit overrides are present.
