...
CREATE TABLE IF NOT EXISTS "public"."restaurant_tables" (
    ...
    "seating_type" "public"."seating_type" NOT NULL,
    "is_active" boolean DEFAULT true NOT NULL,
    "notes" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE ONLY "public"."bookings"
    ADD CONSTRAINT "no_overlap_per_table" EXCLUDE USING "gist" ("table_id" WITH =, "tstzrange"("start_at", "end_at", '[)'::"text") WITH &&) WHERE ((("table_id" IS NOT NULL) AND ("status" = ANY (ARRAY['confirmed'::"public"."booking_status", 'pending'::"public"."booking_status"]))));
...
ALTER TABLE ONLY "public"."restaurant_tables"
    ADD CONSTRAINT "restaurant_tables_restaurant_id_label_key" UNIQUE ("restaurant_id", "label");
...
CREATE INDEX "idx_bookings_table" ON "public"."bookings" USING "btree" ("table_id") WHERE ("table_id" IS NOT NULL);
...
CREATE INDEX "idx_restaurant_tables_features" ON "public"."restaurant_tables" USING "gin" ("features");
...
CREATE INDEX "idx_tables_active" ON "public"."restaurant_tables" USING "btree" ("restaurant_id", "is_active") WHERE ("is_active" = true);
...
CREATE OR REPLACE TRIGGER "restaurant_tables_updated_at" BEFORE UPDATE ON "public"."restaurant_tables" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
CREATE POLICY "Admins and owners can manage tables" ON "public"."restaurant_tables" USING (("restaurant_id" IN ( SELECT "restaurant_memberships"."restaurant_id"
   FROM "public"."restaurant_memberships"
  WHERE (("restaurant_memberships"."user_id" = "auth"."uid"()) AND ("restaurant_memberships"."role" = ANY (ARRAY['owner'::"text", 'admin'::"text"]))))));
...
CREATE POLICY "Staff can view tables" ON "public"."restaurant_tables" FOR SELECT USING (("restaurant_id" IN ( SELECT "public"."user_restaurants"() AS "user_restaurants")));
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "public"."restaurant_tables" TO "service_role";
