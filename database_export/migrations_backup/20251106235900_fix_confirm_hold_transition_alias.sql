-- Fix ambiguous column references inside confirm_hold_assignment_with_transition
...
BEGIN
  ...
  CREATE TEMP TABLE tmp_confirm_assignments ON COMMIT DROP AS
    ...
    FROM public.assign_tables_atomic_v2(
      ...
      p_start_at,
      p_end_at
    ) AS ata(table_id uuid, start_at timestamptz, end_at timestamptz, merge_group_id uuid);
